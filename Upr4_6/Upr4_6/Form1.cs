    ...
    public partial class Form1 : Form
    {
        ...
        private void calculateButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string orderInfo = $"You ordered a {(smallRadioButton.Checked ? "small" : mediumRadioButton.Checked ? "medium" : "large")} " +
                    $" {(thinRadioButton.Checked ? "thin" : "thick")}" +
                    $" pizza{(extraCheeseCheckBox.Checked ? " with extra cheese " : " ")}" +
                    $" and {toppingCheckedListBox.CheckedItems.Count} topping/s: {checkedToppings}.";
