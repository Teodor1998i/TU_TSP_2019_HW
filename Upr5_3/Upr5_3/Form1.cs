...
namespace Upr5_3
{
    public partial class Form1 : Form
    {
        ...
        static string error_name_msg = "Vyvedete trite imena na kirilica";
        static string error_egn_msg = "EGN-to trqbva da e 10 cifri i da zapochva s '1'";
        static string error_addr_msg = "Adresyt trqbva da e samo na kirilica";
